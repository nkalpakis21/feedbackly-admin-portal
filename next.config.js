...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_SHIPLY_API_KEY: process.env.NEXT_PUBLIC_SHIPLY_API_KEY || 'demo-api-key',
    NEXT_PUBLIC_SHIPLY_WEBSITE_ID: process.env.NEXT_PUBLIC_SHIPLY_WEBSITE_ID || 'admin-portal',
  },
};
